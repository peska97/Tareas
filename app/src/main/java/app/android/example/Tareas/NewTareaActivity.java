...
import static app.android.example.Tareas.MainActivity.EXTRA_DATA_ID;
import static app.android.example.Tareas.MainActivity.EXTRA_DATA_UPDATE_ALARMAID;
import static app.android.example.Tareas.MainActivity.EXTRA_DATA_UPDATE_DESCRIPCION;
import static app.android.example.Tareas.MainActivity.EXTRA_DATA_UPDATE_FECHA;
import static app.android.example.Tareas.MainActivity.EXTRA_DATA_UPDATE_FECHAFIN;
import static app.android.example.Tareas.MainActivity.EXTRA_DATA_UPDATE_HORAFIN;
import static app.android.example.Tareas.MainActivity.EXTRA_DATA_UPDATE_FINALIZADO;
import static app.android.example.Tareas.MainActivity.EXTRA_DATA_UPDATE_TITULO;
import static app.android.example.Tareas.MainActivity.EXTRA_DATA_UPDATE_ALARMAACTIVADA;
                        ...
                        if (!TextUtils.isEmpty(mTextFechafinView.getText())) {
                            ...
                            if (!TextUtils.isEmpty(mTextHorafinView.getText())) {
                                ...
                                if (mAlarmaactivada.isChecked()) {
                                    ...
                                    //para nombbre en notrificacion
                                    edit.putString(alarmaid,titulo);
